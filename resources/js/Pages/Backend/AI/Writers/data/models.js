...
export const ModelType = "GPT-3"; // Define and export ModelType if it should be something specific

export const types = ["Type 1", "Type 2"];
export const models = Model; // Correct export for models